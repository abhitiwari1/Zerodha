                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="brand-card">
                            ...
                            <br />
                            <br />
                            <p class="brand-desc">Our asset management venture <br />that is creating simple and transparent index <br />funds to help you save for your goals.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="brand-card">
                            ...
                            <br />
                            <br />
                            <p class="brand-desc">Options trading platform that lets you <br />create strategies, analyze positions, and <br />examine data points like open interest, FI/DII, and more.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="brand-card">
                            ...
                            <br />
                            <br />
                            <p class="brand-desc">Investment research platform <br />that offers detailed insights on stocks <br />, sectors, supply chains, and more.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="brand-card">
                            ...
                            <br />
                            <br />
                            <p class="brand-desc">Systematic trading platform <br />that allows you to create and backtest <br />strategies without coding.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="brand-card">
                            ...
                            <br />
                            <br />
                            <p class="brand-desc">Thematic investing platform <br />that helps you invest in diversified <br />baskets of stocks on ETFs.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="brand-card">
                            ...
                            <br /><br />
                            <p class="brand-desc">Personalized advice on life <br />and health insurance. No spam <br />and no mis-selling.</p>
                        </div>
                    </div>
                </div>
            </div>
