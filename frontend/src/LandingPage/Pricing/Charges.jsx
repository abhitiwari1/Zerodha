export default function Charges() {
    return (
        <div className="container" style={{width: "75%", margin: "auto", marginBottom: "100px"}}>
            <h3>Charges explained</h3>
            <div className="row mt-5 charges">
                <div className="col-6" >
                    <div>
                    ...
                    <div>
                        ...
                        <p>BSE has revised transaction charges for group A, B and other non exclusive scrips (non-exclusive scrips from group E, F, FC, G, GC, W, T) at ₹375 per crore of turnover on flat rate <br />basis w.e.f. December 1, 2022.</p>
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li>Currency - ₹0.05 per lakh + GST of turnover for Futures and ₹2 per lakh + GST of <br />premium for Options.</li>
                        </ul>
                    </div>
                    <div>
                        <h5>Margin Trading Facility (MTF)</h5>
                        <ul>
                            <li>MTF Interest: 0.04% per day (₹40 per lakh) on the funded amount. The interest is applied <br />from T+1 day until the day MTF stocks are sold.</li>
            ...
            <div className="mt-4">
                <h6 style={{fontWeight: "400", fontSize: "17px"}}>Disclaimer</h6>
                <p className="mt-3" style={{fontSize: "13px"}}>For Delivery based trades, a minimum of ₹0.01 will be charged per contract note. Clients who opt to receive physical contract notes will be charged ₹20 per contract note plus courier charges. 
