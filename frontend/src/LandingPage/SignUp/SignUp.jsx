export default function SignUp() {
    return (
        <div className="container mt-5 p-5 mb-5 mt-5" style={{marginLeft: "190px", marginRight: "200px"}}>
            ...
            <div className="row mt-5">
                ...
                <div className="col-6" style={{marginLeft: "-50px", marginTop: "90px"}}>
                    ...
                    <button className="btn btn-primary rounded p-2 mb-4 fs-5" style={{width: "45%", fontWeight: "500"}} type="submit">Get OTP</button>
                <p className="text-muted" style={{fontSize: "0.9rem"}}>By proceeding, you agree to the Zerodha <a className="text-decoration-none" href="">terms</a> & <a className="text-decoration-none" href="">privacy policy</a></p>
                </div>
            </div>
        </div>
    );
