        ...
        <footer className="bg-body-tertiary ">
            <div className="border-top">
                <div className="row mt-4" style={{marginLeft: "150px", marginRight: "150px"}}>
                    <div className="col column">
                        ...
                        <div className=" d-flex justify-content-between" style={{width: "50%"}}>
                            ...
                            <a className='fs-5' href=""><i class="fa-brands fa-whatsapp"></i></a>
                ...
                <div className="mt-5 text-muted" style={{marginLeft: "150px", marginRight: "150px", fontSize: "0.8rem"}}>
                    ...
                    <p className="mt-3">Procedure to file a complaint on <a style={{textDecoration: "none"}} href="">SEBI SCORES</a>: Register on SCORES portal. Mandatory details for filing complaints on SCORES: Name, PAN, Address, Mobile Number, E-mail ID. Benefits: Effective Communication, Speedy redressal of the grievances</p>
                    <a className="mt-3" style={{textDecoration: "none"}} href="">Smart Online Dispute Resolution | Grievances Redressal Mechanism</a>
